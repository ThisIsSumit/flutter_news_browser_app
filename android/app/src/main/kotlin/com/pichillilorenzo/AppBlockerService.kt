    ...
    private val runnable: Runnable = object : Runnable {
        override fun run() {
            ...
            if (appList != null && appList.isNotEmpty()) {
                ...
                if (currentApp != null && currentApp.packageName != "com.pichillilorenzo.flutter_browser") {
                    val launchIntent = packageManager.getLaunchIntentForPackage("com.pichillilorenzo.flutter_browser")
