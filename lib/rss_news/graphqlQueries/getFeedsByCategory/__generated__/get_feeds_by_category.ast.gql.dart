...
const GetFeedsByCategory = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'GetFeedsByCategory'),
  variableDefinitions: [
  ...
  selectionSet: _i1.SelectionSetNode(selections: [
    _i1.FieldNode(
      name: _i1.NameNode(value: 'getFeeds'),
      alias: null,
      arguments: [
        _i1.ArgumentNode(
      ...
      selectionSet: _i1.SelectionSetNode(selections: [
        ...
        _i1.FieldNode(
          name: _i1.NameNode(value: 'feed_url'),
          alias: null,
          arguments: [],
          directives: [],
          selectionSet: null,
...
const document = _i1.DocumentNode(definitions: [GetFeedsByCategory]);
